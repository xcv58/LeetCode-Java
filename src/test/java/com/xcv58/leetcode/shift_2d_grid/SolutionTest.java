...
public class SolutionTest {
    ...
    public void test() {
        ...
        assertEquals(List.of(List.of(1, 2, 3), List.of(4, 5, 6), List.of(7, 8, 9)),
                solution.shiftGrid(new int[][] { { 1, 2, 3 }, { 4, 5, 6 }, { 7, 8, 9 } }, 0));
        assertEquals(List.of(List.of(1, 2, 3), List.of(4, 5, 6), List.of(7, 8, 9)),
                solution.shiftGrid(new int[][] { { 1, 2, 3 }, { 4, 5, 6 }, { 7, 8, 9 } }, 9));
        assertEquals(List.of(List.of(2, 3, 4), List.of(5, 6, 7), List.of(8, 9, 1)),
                solution.shiftGrid(new int[][] { { 1, 2, 3 }, { 4, 5, 6 }, { 7, 8, 9 } }, 8));

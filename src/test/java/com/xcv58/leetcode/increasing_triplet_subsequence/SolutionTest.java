...
public class SolutionTest {
  ...
  private void testIncreasing() {
    ...
    assertFalse(
      solution.increasingSequence(new int[] { Integer.MAX_VALUE, 1 })
    );
    assertFalse(
      solution.increasingSequence(
  ...
  private void testSolution(IncreasingTriplet solution) {
    ...
    assertTrue(
      solution.increasingTriplet(new int[] { Integer.MIN_VALUE, 2, 3 })
    );
  ...
  private void testIncreasingK() {
    ...
    assertTrue(
      solution.increasingK(new int[] { 1, 1, 2, 2, 2, 3, 4, 1, 4, 5, 6 }, 5)
    );
